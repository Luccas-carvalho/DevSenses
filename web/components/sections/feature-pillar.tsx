...
export function FeaturePillar({ pillar, flipped, index }: { pillar: Pillar; flipped: boolean; index: number }) {
  return (
      ...
      >
        <div className="sticky top-24 flex flex-col gap-5">
          <div className="inline-flex w-fit items-center gap-2 px-3 py-1 rounded-full border border-primary/30 bg-primary/[0.06] backdrop-blur-md">
            ...
            <span className="font-mono text-[10px] uppercase tracking-widest text-primary/90">{pillar.label}</span>
          </div>
